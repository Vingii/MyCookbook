...
{
    /// <inheritdoc />
    public partial class RenderCookbook : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Servings = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((1))"),
                    LastCooked = table.Column<DateTime>(type: "date", nullable: true),
                    Guid = table.Column<Guid>(type: "CHAR(38)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((1))")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ingredients", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Ingredien__Recip__5EBF139D",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id");
                });
